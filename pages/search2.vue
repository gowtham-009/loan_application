...
onBeforeMount(() => {
  ...
  //mobile filter
   ...
   const userdata=ref([])
    const getuserdata=async()=>{
      loading.value=true
      error.value=null
      const apiurl='http://localhost/loan%20db/getlastdata_user.php'
    ...
    const mobile_filter=async()=>{
      ...
      loading.value=true
      error.value=null
      const apiurl='http://localhost/loan%20db/search_filter.php'
    ...
    const nameplace_filter=async()=>{
      ...
      loading.value=true
      error.value=null
      const np_apiurl='http://localhost/loan%20db/search_filter.php'
  ...
  loading.value = true
  error.value = null
  const proofid_apiurl = 'http://localhost/loan%20db/search_filter.php'
